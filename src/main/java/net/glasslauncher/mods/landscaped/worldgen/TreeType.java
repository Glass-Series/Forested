...
public enum TreeType {
    ...
    GIGANTEUM(LandscapedBlocks.Wood.giganteum, LandscapedBlocks.Leaves.giganteum, LandscapedBlocks.Sapling.giganteum, (t, l) -> new ThickOakGen(t, l, r -> r.nextInt(8) + 20, (random, layer) -> layer == 0 ? 2 : 2 + random.nextInt(2), r -> r.nextInt(2) + 6, r -> 19 + r.nextInt(2)), List::of),
    ...
    SEQUOIA(LandscapedBlocks.Wood.sequoia, LandscapedBlocks.Leaves.sequoia, LandscapedBlocks.Sapling.sequoia, (t, l) -> new ThickOakGen(t, l, r -> r.nextInt(5) + 12, (random, layer) -> layer == 0 ? 2 : 2 + random.nextInt(2), r -> r.nextInt(2) + 6, r -> 11 + r.nextInt(2)), List::of),
