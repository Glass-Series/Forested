...
public enum TreeType {
    ...
    PAPAYA(LandscapedBlocks.Wood.papaya, LandscapedBlocks.Leaves.papaya, LandscapedBlocks.Sapling.papaya, (t, l) -> new AlternateOakGen(t, l, r -> r.nextInt(3) + 5, (random, layer) -> layer == 0 ? 1 : layer == -1 ? 2 : 1, r -> 2), () -> List.of(Biome.FOREST)),
    PINE(LandscapedBlocks.Wood.pine, LandscapedBlocks.Leaves.pine, LandscapedBlocks.Sapling.larch, (t, l) -> new ConifersGen(t, l, r -> 6 + r.nextInt(2), r -> 2, r -> r.nextInt(2) + 1, r -> r.nextInt(3), r -> 0, r -> 0, r -> 1, r -> 1), () -> List.of(Biome.TAIGA)),
